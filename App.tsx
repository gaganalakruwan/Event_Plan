...
export default function App() {
  ...
  //       // largeIcon: {require('../../')}, // (optional) default: "ic_launcher". Use "" for no large icon.
  //       // largeIconUrl: "https://www.example.tld/pcture.jpg", // (optional) default: undefined
  ...
  //       picture: remoteMessage?.notification?.image, // (optional) Display an picture with the notification, alias of `bigPictureUrl` for Android. default: undefined
